"""
Django settings for confecciones project.
...
ROOT_URLCONF = 'confecciones.urls'
...
DATABASES = {
    'default': {
        ...
        'USER': os.environ.get('DB_USER', 'postgres.qyzyelhmumvmgrehirch'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'leidyconf123.'),
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'comisionescrutadora56@gmail.com'  # Tu dirección de correo electrónico
EMAIL_HOST_PASSWORD = 'comsion56.'  # Tu contraseña de correo electrónico
